...
angular.module('hiin').controller 'ActivityCtrl', ($scope, $rootScope, $window, Util, socket, $modal, storage ) ->

    socket.removeAllListeners("activity")
    socket.removeAllListeners("myInfo")
